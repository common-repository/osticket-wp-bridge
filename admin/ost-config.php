...
<div id="tboxwh" class="pg1">Here you can enter your osTicket version/database information, you should already have osTicket installed to your hosting server, view the osticket-folder/include/ost-config.php file. Look for DBHOST, DBNAME & DBUSER for info needed below.<div style="padding:4px;"></div><b>Landing Page Name:</b> The welcome page can be any name you want: Support, Helpdesk, Contact-Us, ext...the plugin will create this page. <b>Note:</b> If this page exists it will be over written, also this cannot be the same name as your osTicket folder.</div>
<div style="clear: both"></div>
<?php
	...
	'pinged' => '', 
	'post_password' => '', 
	'post_content' => "Place Holder - DO NOT DELETE - osTicket-WP-Bridge", 
	'guid' => '', 
...
<table class="cofigtb">
<tr>
<td class="config_td"><label class="config_label">osTicket Version:</label></td>
<td>
<input type="radio" name="version" value="17" <?php if($version=="17") echo "checked";?>/>v1.7+ &nbsp;&nbsp;or&nbsp;&nbsp;
<input type="radio" name="version" value="18" <?php if($version!="17") echo "checked";?>/>v1.8.1&nbsp;&nbsp;
<a href="javascript:doMenu1('main1');" id="xmain1">[Open]</a>
<span style="padding-left:7px;">( osTicket version you have installed now? )</span>
</td> 
</tr>
<tr>
<td class="cgnote" colspan="2">
<div id="main1" style="display: none;padding-bottom:10px;"><center>Tested & works with osTicket Versions: (1.7.0)&nbsp;&nbsp;(1.7.1.4)&nbsp;&nbsp;(1.7.4)&nbsp;&&nbsp;(1.8.1 &raquo; Is The Current Stable Release)</center>
</div>
</td>
</tr>
<tr>
