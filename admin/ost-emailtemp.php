...
<div class="wrap">
<div class="headtitle">osTicket Email Templates</div>
<div style="clear: both"></div>
<?php require_once( WP_PLUGIN_DIR . '/osticket-wp-bridge/admin/header_nav.php' ); ?>
<div id="tboxwh" class="pg1">The "Email Templates" sent from site to client: new tickets confirmations, user post confirmations & admin post replies.<br />Note: Each input field will have a suggested default template, you can place any text & use the variables listed below.</div>
<div style="clear: both"></div>
<div style="padding-left:15px;padding-bottom:5px;padding-top:6px;"><b>$Variables You can use In Email &darr;</b></div>
<div id="tboxyl" class="pg1">
$username="User Name"&nbsp;|&nbsp;
$usermail="User Email"&nbsp;|&nbsp;
$ticketid="Ticket #"&nbsp;|&nbsp;
...
<div style="clear: both"></div>
<div align="center">
<input type="submit" name="ost-new-ticket" class="button-primary" value="Save - New Ticket Email" />
</div>
</form>
</div>
...
<div style="clear: both"></div>
<div align="center">
<input type="submit" name="ost-admin-reply" class="button-primary" value="Save - Admin Response Email" />
</div>
</form>
</div>
...
<div style="clear: both"></div>
<div align="center">
<input type="submit" name="ost-post-confirmed" class="button-primary" value="Save - User Post Confirmation Email" />
</div>
</form>
</div>
